...
const int POWER_PACK_PIXEL_OFFSET = 0;
const int POWER_PACK_PIXEL_COUNT = 7;

const int PHASER_BARREL_PIXEL_OFFSET = (POWER_PACK_PIXEL_OFFSET + POWER_PACK_PIXEL_COUNT);
const int PHASER_BARREL_PIXEL_COUNT = 3;

const int PHASER_RETICLE_PIXEL_OFFSET = (PHASER_BARREL_PIXEL_OFFSET + PHASER_BARREL_PIXEL_COUNT);
const int PHASER_RETICLE_PIXEL_COUNT = 1;
