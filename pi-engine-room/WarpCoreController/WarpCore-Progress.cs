...
namespace PiController
{
    public class WarpCoreProgress : IAnimationEffect
    {
        ...
        public List<AnimationParameter> Parameters { get; } = new();
        public int RenderOrder => 200;

        public readonly AnimationParameter ProgressPerSecond = new("Progress Per Second", 1, "LED/sec", "How many pixels should the progress meter advance every second");
