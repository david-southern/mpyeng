...
public class SSGEventService
{
    ...
    public event EventHandler? DownloadScreenshotInvoked;

    public void NotifyDownloadScreenshot(object? sender = null, EventArgs? args = null)
    {
        // Make a temporary copy of the event to avoid possibility of
        // a race condition if the last subscriber unsubscribes
        // immediately after the null check and before the event is raised.
        EventHandler? invokeEvent = DownloadScreenshotInvoked;
