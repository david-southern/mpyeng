...
// The sequence point warning indicates that when using constructs like this:
//
// return 1 + (--t) * t * t;
//
// The pre-decrement of t might not occur at the exact time that you want it to.  I'm guessing that the guy that wrote
// this libarary has already sorted that out, so I don't want to see those warnings in this file.
