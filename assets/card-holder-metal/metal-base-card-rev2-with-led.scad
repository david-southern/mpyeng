...
module card_contacts()
{
    ...
    tyz(
        ...
        - card_contact_thickness / 2 // push down so the contacts are in line with the card resting plane
        + card_contact_thickness / 4 // then push back up just a touch so that the contacts stand proud of the resting plane.  Make sure that the contacts get a good connection
    )
