...
export class SSGCanvasManager {
    ...
    public constructor() {
        ...
        this.systemTimeElement = Utils.SafeGetElement(
            SSGCanvasManager.SystemTimeDivID
        );
