...
public static partial class Utils
{
    ...
    /// Note: This method does not consider the number of occurrences of an element in each list, nor does it
    ...
    public static string AddURLQueryParam(string baseUrl, string paramName, object? paramValue)
    {
        ...
        string? paramValueString = Utils.SafeString(paramValue);
    ...
    public static readonly char[] UNAMBIG_ALPHANUM =
    ...
    public static string RandomString(int size)
    {
        ...
        for (int i = 0; i < size; i++)
        {
            ...
            var idx = rnd % UNAMBIG_ALPHANUM.Length;

            result.Append(UNAMBIG_ALPHANUM[idx]);
        }
