...
class CardReaderDigitalManagerClass:
    def __init__(self) -> None:
        ...
        self._ALL_CARD_READERS: list["CardReaderDigital"] = []
        self._ALL_CARD_READERS = []
        self._ALL_CARD_READERS.append(CardReaderDigital(1, self.currentKeyStatus, [0, 1, 2, 3, 4]))
        self._ALL_CARD_READERS.append(CardReaderDigital(2, self.currentKeyStatus, [5, 6, 7, 8, 9]))
    ...
    def AllReaders(self) -> list[CardReaderDigital]:
